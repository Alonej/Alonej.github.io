...
!function(e, t) {
    ...
    var a, v, d, l, h, b = /[-+=\.]*\d+[\.e\-\+]*\d*[e\-\+]*\d*/gi, k = {
        rect: ["width", "height"],
        circle: ["r", "r"],
        ellipse: ["rx", "ry"],
        line: ["x2", "y2"]
    }, P = Math.sqrt, f = "DrawSVGPlugin", u = w(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109), c = function(e) {
        var t = 0 === "http://localhost:4000/2021/12/11/Love/".indexOf(w(102, 105, 108, 101, 58, 47, 47)) || -1 !== e.indexOf(w(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== e.indexOf(w(49, 50, 55, 46, 48, 32, 48, 46, 49))
        ...
        for (setTimeout(function() {
            window && window.console && !window._gsapWarned && a && !1 !== a.config().trialWarn && (console.log(w(37, 99, 87, 97, 114, 110, 105, 110, 103), w(102, 111, 110, 116, 45, 115, 105, 122, 101, 58, 51, 48, 112, 120, 59, 99, 111, 108, 111, 114, 58, 114, 101, 100, 59)),
        ...
        init: function init(e, i) {
            ...
            this._target = e,
            i + "" == "true" ? i = "0 100%" : i ? -1 === (i + "").indexOf(" ") && (i = "0 " + i) : i = "0 0",
            s = function _parse(e, t, n) {
                var i, r, s = e.indexOf(" ");
                return r = s < 0 ? (i = void 0 !== n ? n + "" : e,
                e) : (i = e.substr(0, s),
                e.substr(s + 1)),
                i = o(i, t),
                (r = o(r, t)) < i ? [r, i] : [i, r]
            ...
            l && (a = d.getComputedStyle(e)).strokeLinecap !== a.strokeLinejoin && (s = n(a.strokeMiterlimit),
        ...
        render: function render(e, t) {
            ...
            if (s) {
                for (t._live && (n = A(t._target)) !== t._length && (i = n / t._length,
                t._length = n,
                t._offsetPT && (t._offsetPT.s *= i,
                t._offsetPT.c *= i),
                t._dashPT ? (t._dashPT.s *= i,
                t._dashPT.c *= i) : t._dash *= i); s; )
                    s.r(e, s.d),
                    s = s._next;
                r = t._dash || e && 1 !== e && 1e-4 || 0,
                n = t._length - r + .1,
                o = t._offset,
                r && o && r + Math.abs(o % t._length) > t._length - .2 && (o += o < 0 ? .1 : -.1) && (n += .1),
                a.strokeDashoffset = r ? o : o + .001,
                a.strokeDasharray = n < .2 ? "none" : r ? r + "px," + (t._nowrap ? 999999 : n) + "px" : "0px, 999999px"
            }
        },
        getLength: A,
        getPosition: B
    };
    j() && a.registerPlugin(g),
    e.DrawSVGPlugin = g,
    e.default = g;
