...
!function(t, e) {
    ...
    function convertToPath(t, e) {
        ...
        g = M.width - 2 * o,
        f = M.height - 2 * i,
        n = o || i ? "M" + (v = (d = (p = r + o) + g) + o) + "," + (y = a + i) + " V" + (P = y + f) + " C" + [v, w = P + i * L, m = d + o * L, b = P + i, d, b, d - (d - p) / 3, b, p + (d - p) / 3, b, p, b, c = r + o * (1 - L), b, r, w, r, P, r, P - (P - y) / 3, r, y + (P - y) / 3, r, y, r, x = a + i * (1 - L), c, a, p, a, p + (d - p) / 3, a, d - (d - p) / 3, a, d, a, m, a, v, x, v, y].join(",") + "z" : "M" + (r + g) + "," + a + " v" + f + " h" + -g + " v" + -f + " h" + g + "z") : "circle" === R || "ellipse" === R ? (h = "circle" === R ? (o = i = M.r) * L : (o = M.rx,
        (i = M.ry) * L),
    ...
    function sliceRawPath(t, e, n) {
        ...
        if (p || r) {
            for (i = w < b || L && M < R || T && m.t < d.t,
            y(a, b, R, d.t) && (b++,
            i || (w++,
            T ? (m.t = (m.t - d.t) / (1 - d.t),
            M = 0) : L && (M -= R))),
            Math.abs(1 - (n - e)) < 1e-5 ? w = b - 1 : !m.t && w ? w-- : y(a, w, M, m.t) && i && b++,
        ...
        e !== n)
            for (s = subdivideSegment(P, R, T ? d.t / m.t : d.t),
            L && (l += s),
            v.splice(M + l + 2),
            (s || R) && P.splice(0, R + s),
            h = a.length; h--; )
    ...
    function measureSegment(t, e, n) {
        ...
        if (_)
            for (_ -= C; L < T.length; L++)
                T[L] += _;
        if (T.length && N) {
            if (t.totalLength = y = T[T.length - 1] || 0,
    ...
    function subdivideSegment(t, e, n) {
        ...
        return u += (d - u) * n,
        f += (m - f) * n,
        t.splice(e + 2, 4, B(h), B(g), B(c), B(p), B(c + (u - c) * n), B(p + (f - p) * n), B(u), B(f), B(d), B(m)),
    ...
    function getPositionOnPath(t, e, n, r) {
        ...
        g = c[h = 6 * ~~(h / o)],
        p.x = B((u * u * (c[h + 6] - g) + 3 * f * (u * (c[h + 4] - g) + f * (c[h + 2] - g))) * u + g),
        p.y = B((u * u * (c[h + 7] - (g = c[h + 1])) + 3 * f * (u * (c[h + 5] - g) + f * (c[h + 3] - g))) * u + g),
    ...
    function stringToRawPath(t) {
        ...
        for (e = 0; e < P; e++)
            ...
            "M" === o)
                ...
                u = x - s[s.length - 4],
                g = y - s[s.length - 3],
                s.push(x + u, y + g, r + 2 / 3 * (x + 1.5 * u - r), a + 2 / 3 * (y + 1.5 * g - a), x = r, y = a),
                e += 2;
            else if ("H" === o)
                Af(x, y, x = r, y),
                e += 1;
            else if ("V" === o)
                Af(x, y, x, y = r + (i ? y - x : 0)),
                e += 1;
            else if ("L" === o || "Z" === o)
                "Z" === o && (r = l,
                a = h,
                s.closed = !0),
                ("L" === o || .5 < H(x - r) || .5 < H(y - a)) && (Af(x, y, r, a),
                "L" === o && (e += 2)),
                x = r,
                y = a;
            else if ("A" === o) {
                ...
                d = p.charAt(1),
                p = p.charAt(0)),
                f = arcToSegment(x, y, +m[e + 1], +m[e + 2], +m[e + 3], +p, +d, (i ? x : 0) + 1 * u, (i ? y : 0) + 1 * g),
                e += n,
                f)
    ...
    function pointsToSegment(t, e, n) {
        ...
        s = 2; s < v; s += 2)
            ...
            c *= $(d),
            x === r && y === a || (n < o ? (i = S(g, h),
            b.push(B(x - U(i) * f), B(y - F(i) * f), B(x), B(y), B(x + U(i) * c), B(y + F(i) * c))) : (i = S(u, l),
            b.push(B(x - U(i) * f), B(y - F(i) * f)),
            i = S(R, M),
            b.push(B(x), B(y), B(x + U(i) * c), B(y + F(i) * c)))));
        return x !== P || y !== w || b.length < 4 ? b.push(B(P), B(w), B(P), B(w)) : b.length -= 2,
        L && (b.splice(0, 6),
        b.length = b.length - 6),
        b
    }
    function rawPathToString(t) {
        ...
        for (n = 0; n < i; n++) {
            ...
            e = a.length,
            r = 2; r < e; r++)
                o += B(a[r++]) + "," + B(a[r++]) + " " + B(a[r++]) + "," + B(a[r++]) + " " + B(a[r++]) + "," + B(a[r]) + " ";
            a.closed && (o += "z")
        }
        return o
    }
    ...
    function aa(t, e) {
        ...
        l)
            h ? (o = -(a = function _getCTM(t) {
                var e, n = t.getCTM();
                return n || (e = t.style[z],
                t.style[z] = "none",
                t.appendChild(G),
                n = G.getCTM(),
                t.removeChild(G),
                e ? t.style[z] = e : t.style.removeProperty(z.replace(/([A-Z])/g, "-$1").toLowerCase())),
                n || E.clone()
            }(t)).e / a.a,
            i = -a.f / a.d,
            r = E) : (a = t.getBBox(),
            ...
            D)
                ...
                a = t; (a = a && a.parentNode) && a !== r && a.parentNode; )
                    4 < (v.getComputedStyle(a)[z] + "").length && (o = a.offsetLeft,
                    i = a.offsetTop,
                    a = 0);
    ...
    function oa(t, e, n, r, a, o, i, s, l) {
        return e = "cubic" === i.type ? [e] : (!1 !== i.fromCurrent && e.unshift(ma(n, r, s), a ? ma(n, a, l) : 0),
        i.relative && na(e),
    ...
    var Q, g, W, J, K = "x,translateX,left,marginLeft,xPercent".split(","), tt = "y,translateY,top,marginTop,yPercent".split(","), o = Math.PI / 180, et = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g, nt = function _align(t, e, n) {
        ...
        init: function init(t, e) {
            ...
            if (this.rawPaths = a,
            this.target = t,
            (this.rotate = i || 0 === i) && (this.rOffset = parseFloat(i) || 0,
            ...
            !Array.isArray(o) || "closed"in o || "number" == typeof g)
                ...
                for (r in h && u ? a.push(oa(this, la(la([], o, h, 0), o, u, 1), t, h, u, f, e, s || W(o[0][h]), l || W(o[0][u]))) : h = u = 0,
                g)
