...
//         return p
//     }
//     // p = "var host2=document.domain;var sear=new RegExp('jsdaima');if(!sear.test(host2)){window.location.href='https://www.jsdaima.com/'}";
//     ('0 3=7.8;0 1=5 6(\'2\');f(!1.9(3)){a.b.c=\'d://e.2.4/\'}',16,16,'var|sear|jsdaima|host2|com|new|RegExp|document|domain|test|window|location|href|https|www|if'.split('|'),0,{})
//     );
